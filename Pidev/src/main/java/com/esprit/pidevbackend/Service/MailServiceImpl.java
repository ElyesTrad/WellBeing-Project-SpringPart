  ...
  /*  @Override
    ...
    public void sendEmailNotifAgent(User agent) throws MailException, MessagingException {
        ...
        buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
                ...
                + "								" + 3 + " Simulation are requested to You and Already IN_PROGRESS !!</p>\n"
                + "								<br/>"
                + "							<p>All the best.</p>\n"
                + "                        <p>Thank you.</p>\n"
    ...
    public void sendEmailReservation(long  idUser,long idOffer) throws MessagingException {
        ...
        StringBuilder buf = new StringBuilder();
                ...
                buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
                        ...
                        + "							 < <p>All the best.</p>\n"
                        + "                        <p>Thank you.</p>\n"
                        + "                        <p>Kind Regards !                 <br/> Responsable Collaboration.</p>\n"
                        + "                      </td>\n" + "                    </tr>\n" + "                  </table>\n"
                        + "                </td>\n" + "              </tr>\n" + "\n"
                        + "            <!-- END MAIN CONTENT AREA -->\n" + "            </table>\n"
                        + "            <!-- END CENTERED WHITE CONTAINER -->\n" + "\n" + "            <!-- START FOOTER -->\n"
    ...
    public void sendRappelEmailReservation(long idReservation) throws MessagingException{
        ...
        StringBuilder buf = new StringBuilder();
                ...
                buf.append("\"<html>\n" + "  <head>\n" + "    <meta name=\"viewport\" content=\"width=device-width\" />\n"
                        ...
                        + "                  <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\n"
                        + "                    <tr>\n" + "                      <td>\n"
                        + "                        <b>Rattle Event : " + r.getUserRes().getName() + " ,\"</b>\n"
                        + "                        <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\">\n"
                        + "                          <tbody>\n" + "                            <tr>\n"
                        + "                              <td align=\"left\">\n"
                        + "                                <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\n"
                        ...
                        + "                            </tr>\n" + "                          </tbody>\n"
                        + "                        </table>\n" + "<p>We Hope You Are Doing Well ! </p>\n"
                        + "                        <b>We are now pleased to inform you that you have the reservation of : " + r.getOffersRes().getTitle() + " ,\"</b>\n"
                        + "                        <b>place Event : " + r.getNmPalce() + " ,\"</b>\n" + "<br>"
                        + "                        <b>date Event : " + r.getStartDateRes() + " ,\"</b>\n"
                        + "							<b>date Event : " + r.getEndDateRes() + " ,\"</b>\n"	+" <br/>"
                        + "							<p>All the best.</p>\n"
                        + "                        <p>Thank you.</p>\n"
