...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers( "/api/login/**","/api/token/refresh/**","/admin/**","/api/images/**","/timeTable/**","/","/timeslots/**","/timeslots/solve/**","/rooms/**","/competitions/**","/profile/**","/api/linkedInLogin/**","/api/getToken","/result/**","/api/forgot-password","/api/reset-password/**","/api/role/save").permitAll();
