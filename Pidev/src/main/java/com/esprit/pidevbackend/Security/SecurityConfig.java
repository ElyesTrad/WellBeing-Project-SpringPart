...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers( "/api/login/**","/api/token/refresh/**","/timeTable/**","/","/profile/**","/api/getToken","/commentPub/addCommentToPubAndUser/**","/api/user/save/**","/api/role/save","/api/role/addtouser/**","/ConseilUser/**","/QVT/**","/Answer/**").permitAll();
        http.authorizeRequests().antMatchers( "/Evaluation/Add-AchievementsAndEvaluation/**","/Evaluation/Increment-ActivityPointsLike/**","/Evaluation/Increment-ActivityPointsComment/**",
